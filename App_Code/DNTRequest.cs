...
namespace light.Common
{
	...
	public class DNTRequest
	{
		...
		public static string GetIP()
		{
			...
			if (null == result || result == String.Empty || !Utility.IsIP(result))
			{
				return "0.0.0.0";
			}
...
//				if(Utility.InArray(fileextname, AllowFileExtName) && (filesize <= MaxAllowFileSize * 1024) && Utility.InArray(filetype, AllowFileType))
//				{
//
//					HttpContext.Current.Request.Files[i].SaveAs(Dir + Utility.GetDateTime() + Environment.TickCount.ToString() + fileextname);

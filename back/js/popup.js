...
function getValue(str) {
    ...
    case "scrollLeft":
        if (typeof(window.pageXOffset) != 'undefined') {
            nResult = window.pageXOffset;
        } else if (typeof(document.compatMode) != 'undefined' && document.compatMode != 'BackCompat') {
            nResult = document.documentElement.scrollLeft;
        } else if (typeof(document.body) != 'undefined') {
            nResult = document.body.scrollLeft;
        }
        break;
    case "clientWidth":
...
setContent: function(arrt, val) {
    ...
    build: function() {
        ...
        var path = "";
        var close = '<input type="image" id="dialogBoxClose" src="/images/dialogclose.gif" border="0" width="16" height="16" align="absmiddle" title="关闭"/>';
    ...
    lastBuild: function() {
        var confirm = '<div style="width:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">' + this.info.confirmCon + '</div><div style="padding:20px;"><input id="dialogOk" type="button" value=" 确定 "/>&nbsp;<input id="dialogCancel" type="button" value=" 取消 "/></div></div>';
        var alert = '<div style="width:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">' + this.info.alertCon + '</div><div style="margin:20px;"><input id="dialogYES" type="button" value=" 确定 "/></div></div>';
        var baseZIndex = 10001 + this.info.overlay * 10;
...
Dragdrop.prototype = {
    ...
    var sLeft = getValue("scrollLeft");
    var sTop = getValue("scrollTop");
    var cWidth = getValue("clientWidth");
    var cHeight = getValue("clientHeight");
        var mousX = Event.pointerX(event) - sLeft;
        var mousY = Event.pointerY(event) - sTop;
        var oObjBottom;
        var oObjRight;
        if (this.showShadow) {
        ...
        if (mousX < 1 || mousY < 1 || mousX > cWidth || mousY > cHeight || parseInt(this.oObj.style.left) < 0 || parseInt(this.oObj.style.top) < 0 || oObjRight > cWidth || oObjBottom > cHeight) {

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add.aspx.cs" Inherits="news_add"
            ...
            <div class="right1">
                <table class="user_info_table table_a">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="title" type="text" id="title" class="w300" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                        ...
                        <td>
                            显示：<input id="isopen" name="isopen" type="checkbox" checked="checked" />&nbsp;&nbsp;推荐:<input id="isrecommend" name="isrecommend" type="checkbox" checked="checked" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <textarea id="description" name="description" style="width: 100%; height: 400px; visibility: hidden;"></textarea>
                        </td>
                    </tr>
                    <tr>

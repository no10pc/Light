<%@ Page Language="C#" AutoEventWireup="true" CodeFile="showlist.aspx.cs" Inherits="category_showlist" %>
        ...
        <div class="Main">
            ...
            <div class="right1">
                <table class="table_a marginb10">
                    ...
                    <%
                        System.Data.DataTable dt = new light.BLL.category().GetList(" parentid=0 ").Tables[0];
                    ...
                    <%
                        System.Data.DataTable dt1 = new light.BLL.category().GetList(" parentid=" + dr["pkid"].ToString()).Tables[0];

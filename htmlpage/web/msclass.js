...
Marquee.prototype.Start = function()
{
	...
	{		
		if(this.Width == 0)this.Width = parseInt(this.ID.offsetWidth);	//style.width
		if(this.Height == 0)this.Height = 150;
	}else{
		if(this.Width == 0)this.Width = 150;
		if(this.Height == 0)this.Height = parseInt(this.ID.offsetHeight);
	}

            ...
            <tbody>
                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td style="padding-left: 45px; color: #ffffff; font-size: 14px; font-weight: bold"
                                        height="39" background="/images/title.jpg"><% = pageModel._产品分类 %>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: 2px; padding-left: 5px; padding-right: 5px; padding-top: 2px"
                                        valign="top">
                                        <% = base.procategoryList(pageVal)%>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <td valign="top" width="720">
                                ...
                                <tr>
                                    <td height="39" background="/images/title.jpg">
                                        <table style="z-index: 100" border="0" cellspacing="0" cellpadding="0" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td style="padding-left: 35px; color: #ffffff; font-size: 14px; font-weight: bold"><% = pageModel._公司简介 %>
                                                    </td>
                                                    <td style="padding-right: 10px; color: #ffffff" align="right">
                                                        <a href="index-20.html">
                                                            <img border="0" src="/images/more1.png" width="38" height="17"></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="line-height: 150%; color: #000000">
                                                        <% = new myBase().getCompanyInfi(pageVal) %>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <table style="z-index: 100" border="0" cellspacing="0" cellpadding="0" width="100%" height="50">
                            <tbody>
                                <tr>
                                    <td valign="top">
                                        <table style="z-index: 100" border="0" cellspacing="0" cellpadding="0" width="715">
                                            <tbody>
                                                <tr>
                                                    <td height="35" background="/images/xwt.jpg" width="351">
                                                        <table style="z-index: 100" border="0" cellspacing="0" cellpadding="0" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="padding-left: 13px; color: #ffffff; font-size: 13px; font-weight: bold; padding-top: 3px"><% = pageModel._企业新闻 %>
                                                                    </td>
                                                                    <td style="padding-right: 10px; color: #ffffff; padding-top: 3px" align="right">
                                                                        <a href="index-21.html">
                                                                            <img border="0" src="/images/more.jpg" width="37" height="15"></a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <td height="35" background="/images/xwt.jpg" width="351">
                                                        <table style="z-index: 100" border="0" cellspacing="0" cellpadding="0" width="100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="padding-left: 13px; color: #ffffff; font-size: 13px; font-weight: bold; padding-top: 3px"><% = pageModel._新闻关注 %>
                                                                    </td>
                                                                    <td style="padding-right: 10px; color: #ffffff; padding-top: 3px" align="right">
                                                                        <a href="index-21.html">
                                                                            <img border="0" src="/images/more.jpg" width="37" height="15"></a>
                                                ...
                                                <tr>
                                                    <td style="padding-bottom: 2px; padding-left: 10px; padding-right: 10px; padding-top: 2px"
                                                        valign="top" background="/images/xwm.jpg">
                                                        <%= base.news(1,pageVal) %>
                                                    </td>
                                                    <td>&nbsp;
                                                    </td>
                                                ...
                                                <tr>
                                                    <td height="8" background="/images/xwbottom.jpg"></td>
                                                    <td></td>
                                                    <td height="8" background="/images/xwbottom.jpg"></td>
                                                    <td></td>
                                                </tr>
                        ...
                        <table style="z-index: 100; margin-top: 3px" border="0" cellspacing="0" cellpadding="0"
                            width="100%">
                            <tbody>
                                <tr>
                                    <td height="39" background="/images/title.jpg">
                                        <table style="z-index: 100" border="0" cellspacing="0" cellpadding="0" width="100%">
                                            <tbody>
                                                <tr>
                                                    <td style="padding-left: 35px; color: #ffffff; font-size: 14px; font-weight: bold"><% = pageModel._产品展示 %>
                                                    </td>
                                                    <td style="padding-right: 10px; color: #ffffff" align="right">
                                ...
                                <tr>
                                    <td style="padding-bottom: 2px; padding-left: 10px; padding-right: 10px; padding-top: 2px">
                                        <div style='border: 0 solid #c0c0c0; text-align: left; overflow: hidden; width: 680px; line-height: 18px;'
                                            id='textdiv_201061119175080'>
                                            <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="display: inline">
                                                <tr>
                                                    <td>
                                                        <table width="100%" class="Board_Tab" border="0" cellspacing="5" cellpadding="0">
                                                            <tr>
                                                                <%=base.getproducts(pageVal) %>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                        ...
                                        <script language="javascript" type="text/javascript"> setTimeout("new Marquee('textdiv_201061119175080',2,1,680,100,30,0,0);", 500)</script>
